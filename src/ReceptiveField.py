...
def parsing():
    ...
    parser.add_argument('--img', type=str, default="False", help='generate image as in the readme [True, False]')
...
if __name__ == "__main__":
    ...
    if model == "vgg16":
        ...
        summary(model, (3, 224, 224), receptive_field=True)
